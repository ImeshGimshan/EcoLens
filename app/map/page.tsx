...
export default function MapPage() {
        ...
        async (latitude: number, longitude: number) => {
            ...
            try {
                ...
                if (data.sites) {
                    ...
                    sitesWithDistance.sort((a: HeritageSite, b: HeritageSite) => (a.distance || 0) - (b.distance || 0));
    ...
    const handleScanSite = (site: HeritageSite) => {
        // TODO: Navigate to camera/scan page with site info
        console.log('Scanning site:', site);
        // For now, just show an alert
        alert(`Ready to scan: ${site.name}\n\nCamera feature coming soon!`);
    };
